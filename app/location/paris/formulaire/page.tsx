...
export default function LocationParisFormulairePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      sessionStorage.setItem('location_paris_etape1', JSON.stringify(formData))
      router.push('/location/paris/formulaire/etape-2')
    } catch (error: any) {
      ...
      <div className="w-full max-w-xl">
        <div className="text-center mb-10">
          ...
          <p className="text-white text-base mt-6 max-w-lg mx-auto leading-relaxed font-medium" style={{ fontFamily: 'var(--font-poppins), sans-serif' }}>
            Afin de préparer la mise en location de votre bien à Paris, veuillez préparer des photos de votre bien.
          </p>
        </div>
