        ...
        <form onSubmit={handleSubmit} className="space-y-10">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <input type="text" name="adresseComplete" value={formData.adresseComplete} onChange={handleChange} required placeholder="Ex: 12 rue de la Paix" className={inputClass} style={fontStyle} />
            </div>
              ...
              <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 gap-3">
                {photoPreviews.map((preview, index) => (
                  <div key={index} className="relative group aspect-square rounded-lg overflow-hidden border border-white/10">
                    <Image src={preview} alt={`Photo ${index + 1}`} fill unoptimized className="object-cover" />
